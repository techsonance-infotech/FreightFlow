...
export const metadata: Metadata = {
  title: 'Create Account — FreightFlow',
  description: 'Register for a new FreightFlow account and start your 7-day free trial.',
};
  ...
  return (
    <div className="w-full lg:grid lg:h-screen lg:grid-cols-2 bg-white overflow-hidden">
      ...
      <div className="flex items-center justify-center py-12 bg-white h-screen relative overflow-y-auto lg:overflow-hidden">
        ...
        <div className="mx-auto grid w-full max-w-[750px] gap-8 px-8 relative z-10">
          {/* Mobile Logo */}
          ...
          <div className="flex flex-col gap-2 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium">
              Experience the next generation of transport management.
            </p>
          </div>
