...
import { 
  ...
  Inbox, Scale, BarChart3, Users, IndianRupee
} from 'lucide-react';
                    ...
                    >
                      ...
                      <td className="px-6 py-6" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-center gap-2">
                          ...
                          <button
                            onClick={async () => {
                              if (confirm('Are you sure you want to delete this outward pallet load?')) {
                                try {
                                  const res = await fetch(`/api/v1/pallets/${pallet.id}`, { method: 'DELETE' });
                                  if (res.ok) {
                                    toast.success('Palletized load deleted successfully');
                                    fetchPallets(meta.page);
                                    fetchStats();
                                  } else {
                                    toast.error('Failed to delete palletized load');
                                  }
                                } catch (error) {
                        ...
                        <td colSpan={7} className="px-12 py-8 border-l-4 border-blue-500">
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="space-y-6">
                              ...
                              <Button 
                                onClick={() => router.push(`/dashboard/pallets/${pallet.id}`)}
