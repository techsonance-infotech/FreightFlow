      ...
      <div className="space-y-10 animate-pulse p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="h-40 bg-slate-50 rounded-[2.5rem] border border-slate-100 p-8 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="h-96 bg-white rounded-[2.5rem] border border-slate-100 p-10 space-y-6">
                 <div className="flex justify-between">
                 ...
                 <div className="space-y-4 pt-4">
                    {Array.from({ length: 4 }).map((_, j) => (
                       <div key={j} className="h-14 bg-slate-50/50 rounded-2xl border border-slate-50" />
                    ))}
                 </div>
              </div>
           ))}
