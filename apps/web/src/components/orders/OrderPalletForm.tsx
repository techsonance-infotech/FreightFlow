            ...
            <div className="p-0 overflow-x-auto">
                    ...
                    <tr key={field.id} className="group hover:bg-blue-50/20 transition-all duration-300">
                      ...
                      <td className="px-4 py-6 align-top">
                        <div className="flex gap-2">
                          <div className="flex-1 relative">
                            ...
                            <div className="absolute top-full left-0 right-0 z-50 mt-2 bg-white rounded-2xl border border-slate-100 shadow-2xl overflow-hidden opacity-0 invisible group-focus-within:opacity-100 group-focus-within:visible transition-all max-h-[250px] overflow-y-auto">
                          ...
                          <button 
                            ...
                            className="h-11 w-11 rounded-xl bg-blue-50 text-blue-600 hover:bg-blue-600 hover:text-white transition-all flex items-center justify-center shrink-0 shadow-sm"
                          >
                      ...
                      <td className="px-6 py-6 text-center align-top">
                        <button 
                          ...
                          className="p-2 rounded-lg text-slate-200 hover:text-rose-500 hover:bg-rose-50 transition-all disabled:opacity-0"
                        >
              ...
              <div className="p-8 bg-white border-t border-slate-50 flex justify-between items-center rounded-b-3xl">
                <div className="flex gap-16">
                  ...
                  <div className="space-y-1">
                    <p className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Total Quantity</p>
        ...
        <div className="lg:col-span-5 xl:col-span-4 space-y-8">
          ...
          <div className="pt-4 flex flex-col gap-3">
            ...
            <Button 
              ...
              variant="ghost" 
              onClick={onCancel}
              className="h-14 rounded-2xl font-black uppercase tracking-widest text-[10px] text-slate-400 hover:text-slate-600"
            >
              Cancel
            </Button>
          </div>
