...
import { Sparkles, IndianRupee, Scale, Navigation, TrendingUp, Smartphone } from 'lucide-react';
        ...
        >
          {ADVANTAGES.map((item, i) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-ff-navy-700/30 border border-ff-navy-700/50 flex items-center justify-center mb-6 group-hover:scale-110 group-hover:border-ff-teal-500/30 transition-all duration-300">
